...
/**
 * @Description:MP代码生成器
 * 已生成代码的表，再次生成，不会覆盖。需要删除源文件后生成。
 **/

public class BlogGeneratorCode {

    static final String URL = "jdbc:mysql://60.204.186.79:10426/genshin_tool?serverTimezone=UTC";

    // 根据模块名和父包路径修改这两个常量即可
    static final String moduleName = "blog";
    static final String parent = "com.zzz.blog";



    public static void main(String[] args) {

        String projectPath = System.getProperty("user.dir") + "\\" + moduleName;//获取项目路径
